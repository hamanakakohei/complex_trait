...
def parse_args():
    ...
    p.add_argument("--qtl", type=Path, required=True, help="snpかどうかで事前にフィルターするべきか注意を払う")
    ...
    p.add_argument("--qtl_analysis_variants", type=Path, help="qtl解析で使ったバリアントリストを与えると、それとcausaldbでかぶっているバリアントのみ考慮する")
...
def main():
    ...
    # qtl解析対象のバリアントにしぼるかどうか
    if args.qtl_analysis_variants:
    ...
    out_variants_path = args.prefix + ".variants.txt.gz"
